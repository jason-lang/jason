...
The name is also somehow inspired by in Greek mythology. Click http://www.perseus.tufts.edu/cgi-bin/ptext?doc=Perseus%3Atext%3A1999.04.0004%3Ahead%3D%234815[here] for an entry on Jason in the Perseus Encyclopaedia (Perseus is an
