...
- https://www.wiley.com/en-gb/Programming+Multi-Agent+Systems+in+AgentSpeak+using+Jason-p-9780470029008[Jason book]
...
* xref:./tech/performatives.adoc[List of implemented communication performatives]
