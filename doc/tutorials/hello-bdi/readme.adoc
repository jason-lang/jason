...
used in the http://jason-lang.github.io/jason[Jason] agent-oriented programming
...
(http://jason-lang.github.io/jason/api/jason/stdlib/my_name.html[`.my_name`]
...
1. Write a new plan for Bob so that on Saturdays he drops all his intentions. The internal action http://jason-lang.github.io/jason/api/jason/stdlib/drop_all_intentions.html[`.drop_all_intentions`] may help for that.
2. Write a plan for Bob so that as soon as it realises that someone is happy, he shares this information with Carlos *only* if Bob intends to `say(hello(carlos))`. The internal action http://jason-lang.github.io/jason/api/jason/stdlib/intend.html[`.intend`] may help for that.
...
http://jason-lang.github.io/jason/api/jason/stdlib/package-summary.html#package.description[Jason
