...
//The overall process of launching distributed agents can be simplified by the Ant script created by Jason as explained in the http://jason.sf.net/faq[FAQ].
