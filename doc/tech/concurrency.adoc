...
In this example, the parameters of the agent *ana* say that the number of cycles for the sense and deliberate stages are `2`, while the number of cycles for the act stage is `10`.

----
ana [cycles_sense = 2, cycles_deliberate = 2, cycles_act = 10];
----

In this example, the parameters of the agent *bob* says that the number of cycles for the senquence sense-deliberate-act is `10`.
