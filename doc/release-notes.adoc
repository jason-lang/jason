...
- the selection of options for an event can be customised in the AgentSpeak code by a rule `select__option`. For instance, the agent can customise it to select plans that follow norms. See demos/selectOptionBB for an example.
