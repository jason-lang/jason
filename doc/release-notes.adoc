...
The main new feature of Jason 3.2 is the Jason Command Line Interface (*JasonCLI*). This tools is created to support the creation and monitoring of Jason application independently of IDEs. More information xref:../jason-cli/readme.adoc[here].
