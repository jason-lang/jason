...
- new internal action `.intention` used to inspect the state of intentions. It also replaces `.current_intention`.
- add option `--log-conf` to setup the logging configuration file when launching the application
