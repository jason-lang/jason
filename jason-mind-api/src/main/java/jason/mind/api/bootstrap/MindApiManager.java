...
import jason.mind.api.infrastructure.adapter.in.jason.AgentLogListener;
import jason.mind.api.infrastructure.mapper.intention.IntentionSnapshotMemory;
...
public class MindApiManager extends MindInspectorWeb {
    ...
    public void removeAg(Agent agent) {
        IntentionSnapshotMemory.getInstance().clearAgent(agent.getTS().getAgArch().getAgName());
    }
