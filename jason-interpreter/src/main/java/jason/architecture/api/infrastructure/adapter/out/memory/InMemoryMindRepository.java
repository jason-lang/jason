package jason.architecture.api.infrastructure.adapter.out.memory;
...
import jason.architecture.api.application.snapshot.model.CycleInfo;
import jason.architecture.api.application.snapshot.model.MessageSnapshot;
import jason.architecture.api.application.log.port.out.AgentLogRepository;
