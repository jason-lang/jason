...
- The Jason.exe and Jason.app are not provided anymore. The jEdit + Jason plugin can be run by double clicking on `jedit/jedit.jar` file. See more about it on the getting started tutorial.
